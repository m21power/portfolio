...
export const commands: Command = [
  { cmd: "about", desc: "Information about Mesay Lemma", tab: 8 },
  { cmd: "education", desc: "Show education background", tab: 4 },
  { cmd: "projects", desc: "Show experience and completed projects", tab: 5 },
  { cmd: "socials", desc: "View social media accounts", tab: 6 },
  { cmd: "clear", desc: "Clear the terminal screen", tab: 8 },
  { cmd: "echo", desc: "Display input text", tab: 9 },
  { cmd: "email", desc: "Send an email", tab: 8 },
  // { cmd: "gui", desc: "Open portfolio in GUI mode", tab: 10 },
  { cmd: "history", desc: "Show command history", tab: 6 },
  { cmd: "pwd", desc: "Show current working directory", tab: 10 },
  { cmd: "themes", desc: "List available themes", tab: 7 },
  { cmd: "welcome", desc: "Show hero section", tab: 6 },
  { cmd: "whoami", desc: "Show current user information", tab: 7 },
